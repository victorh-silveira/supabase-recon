...
Os gates executam `app/scripts/operations/clean_workspace.py --area python --stage ...` (YAML/JSON no lint/validate Python). O job CI - Workflows roda o step `Workflows | Lint` (actionlint).
